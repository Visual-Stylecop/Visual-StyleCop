//--------------------------------------------------------------------------
// <copyright file="FileAnalysisHelper.cs" company="http://stylecop.codeplex.com">
//   MS-PL
// </copyright>
// <license>
...
namespace StyleCop.VisualStudio
{
    ...
    internal class FileAnalysisHelper : AnalysisHelper
    {
        ...
        /// </summary>
        /// <returns>
        /// Returns true if all documents were saved, or false if one or more
        /// documents were unable to be saved.
        /// </returns>
