...
HRESULT __stdcall GetExceptionCategoryMetric(_In_ REFGUID guidType, _Out_opt_ LPBSTR pbstrExceptionCategoryName, _Out_opt_ LPDWORD pdwState, _In_opt_z_ LPCTSTR pszAltRoot);

HRESULT __stdcall EnumExceptionMetrics(_In_ REFGUID guidType, _Outref_result_buffer_to_(*pdwSize, *pdwSize) LPBSTR& rgbstrExceptions, _Outref_result_buffer_to_(*pdwSize, *pdwSize) LPDWORD& rgdwState, _Outref_result_buffer_to_(*pdwSize, *pdwSize) LPDWORD& rgdwCode, _Ret_notnull_ LPDWORD pdwSize, LPCWSTR pszAltRoot);

HRESULT __stdcall EnumExceptionCategoryMetrics(_Outref_result_buffer_to_(*pdwSize, *pdwSize) LPGUID& rgguidTypes, _Outref_result_buffer_to_(*pdwSize, *pdwSize) LPBSTR& rgbstrExceptions, _Outref_result_buffer_to_(*pdwSize, *pdwSize) LPDWORD& rgdwState, _Ret_notnull_ LPDWORD pdwSize, _In_ LPCWSTR pszAltRoot);
