...
#ifndef __UiContextSynchronousSolutionOperation_FWD_DEFINED__
#define __UiContextSynchronousSolutionOperation_FWD_DEFINED__
typedef interface UiContextSynchronousSolutionOperation UiContextSynchronousSolutionOperation;

#endif 	/* __UiContextSynchronousSolutionOperation_FWD_DEFINED__ */
...
#ifndef __UiContextSynchronousSolutionOperation_INTERFACE_DEFINED__
#define __UiContextSynchronousSolutionOperation_INTERFACE_DEFINED__

/* interface UiContextSynchronousSolutionOperation */
/* [object][uuid] */ 


EXTERN_C const IID IID_UiContextSynchronousSolutionOperation;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("30315F71-BB05-436B-8CC1-6A62B368C842")
    UiContextSynchronousSolutionOperation : public IUnknown
    {
    public:
    };
    ...
    typedef struct UiContextSynchronousSolutionOperationVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            __RPC__in UiContextSynchronousSolutionOperation * This,
        ...
        END_INTERFACE
    } UiContextSynchronousSolutionOperationVtbl;

    interface UiContextSynchronousSolutionOperation
    {
        CONST_VTBL struct UiContextSynchronousSolutionOperationVtbl *lpVtbl;
    };
...
#define UiContextSynchronousSolutionOperation_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define UiContextSynchronousSolutionOperation_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define UiContextSynchronousSolutionOperation_Release(This)	\
...
#endif 	/* __UiContextSynchronousSolutionOperation_INTERFACE_DEFINED__ */


/* interface __MIDL_itf_vsshell121_0000_0001 */
/* [local] */ 

#define UICONTEXT_SynchronousSolutionOperation IID_UiContextSynchronousSolutionOperation
...
/* interface __MIDL_itf_vsshell121_0000_0002 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_vsshell121_0000_0002_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_vsshell121_0000_0002_v0_0_s_ifspec;
...
/* interface __MIDL_itf_vsshell121_0000_0010 */
/* [local] */ 
...
extern RPC_IF_HANDLE __MIDL_itf_vsshell121_0000_0010_v0_0_c_ifspec;
extern RPC_IF_HANDLE __MIDL_itf_vsshell121_0000_0010_v0_0_s_ifspec;
