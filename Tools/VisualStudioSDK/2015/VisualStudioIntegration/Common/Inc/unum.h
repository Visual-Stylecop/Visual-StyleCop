...
long WINAPI WStrToLong (
    ...
    _Outptr_opt_result_z_ const WCHAR **  endptr = NULL,      // optional address of pointer to end of number, or start if not a number
...
unsigned long WINAPI WStrToULong (
    ...
    _Outptr_opt_result_z_ const WCHAR **  endptr = NULL,
    int             ibase = 10,
