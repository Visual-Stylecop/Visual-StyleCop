...
enum AD7_HRESULT
{
    ...
    E_DOTNETNATIVE_SDK_NOT_INSTALLED__ = 0x80040D18,
    ...
    E_MSENC_INSTALL_ERROR__ = 0x80040D19,
    ...
    E_REMOTE_MSVSMON_TOO_OLD__ = 0x80040D1A,
    ...
    E_REMOTE_IDE_TOO_OLD__ = 0x80040D1B
};
...
#define E_DOTNETNATIVE_SDK_NOT_INSTALLED _HRESULT_TYPEDEF_(E_DOTNETNATIVE_SDK_NOT_INSTALLED__)
#define E_MSENC_INSTALL_ERROR _HRESULT_TYPEDEF_(E_MSENC_INSTALL_ERROR__)
#define E_REMOTE_MSVSMON_TOO_OLD _HRESULT_TYPEDEF_(E_REMOTE_MSVSMON_TOO_OLD__)
#define E_REMOTE_IDE_TOO_OLD _HRESULT_TYPEDEF_(E_REMOTE_IDE_TOO_OLD__)
